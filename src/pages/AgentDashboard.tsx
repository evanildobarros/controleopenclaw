...
export function AgentDashboard({ agents, fixedUid }: AgentDashboardProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 text-gray-800 dark:text-gray-200 transition-colors duration-200">
      {/* HEADER DO AGENTE */}
      <div className="mb-8">
      ...
      {activeTab === 'brain' && (
        <div className="flex flex-col h-[70vh] border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-gray-900 overflow-hidden shadow-2xl dark:shadow-none">
           <div className="flex border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
             {(['SOUL.md', 'IDENTITY.md', 'MEMORY.md'] as BrainFile[]).map(file => (
                <button
                  ...
                  className={`px-6 py-3 font-mono text-sm border-r border-gray-200 dark:border-gray-800 flex items-center gap-2 transition-colors ${
           ...
           <div className="flex-1 flex overflow-hidden">
             <div className={`flex-1 border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-black ${!isEditing && 'hidden'}`}>
                <textarea 
             ...
             {/* Preview lado */}
             <div className={`flex-1 bg-white dark:bg-gray-900 p-6 overflow-y-auto custom-scrollbar prose max-w-none ${!isEditing && 'w-full flex-none'}`}>
